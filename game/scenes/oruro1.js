States.Oruro1 = function(game){
};

States.Oruro1.prototype = {
	init: function() {
		this.game.renderer.renderSession.roundPixels = true;
		this.physics.startSystem(Phaser.Physics.ARCADE);
	},
	create: function(){
		this.game.background = this.game.add.tileSprite(0, 0, 2048, 1474, 'oruro1');
		...
		this.game.taxi = this.createObstacle(1887, 7, 151, 247);
...
States.Oruro1.prototype.checkPlayerEnemyCollision = function(element, index, array) {
...
States.Oruro1.prototype.checkEnemyObstacleCollision = function(element, index, array) {
	this.game.physics.arcade.collide(element.sprite, this.game.obstacles);
}

States.Oruro1.prototype.createObstacle = function(x, y, width, height) {
...
States.Oruro1.prototype.handleItemCollision = function (duke, item) {
...
States.Oruro1.prototype.nextScene = function(duke, taxi) {
	this.state.start('Sajama');
}